<template>
	<view class="home">
		<!-- 头部导航栏 -->
		<!-- #ifndef MP-WEIXIN -->
		<u-navbar  back-icon-name='' :background="{background: '#EC4141'}" height="0" class="navbar">
		 <!-- #endif -->
		</u-navbar>
		<!-- 整屏滑动头部 -->
		...
		<swiper :current="swiperCurrent" @transition="transition" @animationfinish="animationfinish" class="swiper-box">
			...
			<swiper-item class="mine">
				<scroll-view scroll-y style="height: 100%;width: 100%;" class="swiper-item"><mine :user="user"></mine></scroll-view>
			</swiper-item>
			<!-- 发现页面 -->
